...
/// <summary>
/// MAUI-specific factory for creating WorkflowViewModel instances with dependencies
/// </summary>
public class MauiWorkflowViewModelFactory : IWorkflowViewModelFactory
{
    private readonly ISpeakerEngine? _speakerEngine;
    private readonly Project? _project;
    private readonly Z21? _z21;

    public MauiWorkflowViewModelFactory(
