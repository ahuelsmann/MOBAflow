...
[TestFixture]
internal sealed class InterlockingControlViewModelTests
{
    [Test]
    public void RuntimeSnapshotChanged_TwoPageViewModels_ProjectSameRevisionAndTurnoutState()
    {
        // Arrange
        ...
        var projected = fixture.Engine.ProjectTurnoutCommand(
    ...
    [Test]
    public void RepresentationSelection_PhysicalAndLogicalBindingsResolveSameOperationalTurnout()
    {
        // Arrange
        var fixture = CreateFixture();
        var trackPage = fixture.CreateViewModel();
    ...
    [Test]
    public async Task SetTurnoutStraightCommand_SynchronizedUnlockedTurnout_UsesSemanticRuntimeBoundary()
    {
        // Arrange
        var fixture = CreateFixture();
        ...
        // Act
        await viewModel.SetTurnoutStraightCommand.ExecuteAsync(null);
    ...
    [Test]
    public void LockedTurnout_CannotOperateAndIncludesNonColorLockDescription()
    {
        // Arrange
        var fixture = CreateFixture();
        ...
        Mock<IInterlockingRuntime> Runtime)
    {
        ...
        public InterlockingControlViewModel CreateViewModel() =>
            new(
                Runtime.Object,
                EventBus,
                new TestProjectContext(Project),
    ...
    private sealed class TestProjectContext : IProjectContext
    {
        ...
        public TestProjectContext(Project project)
        {
            _selectedProject = new ProjectViewModel(project);
        }
