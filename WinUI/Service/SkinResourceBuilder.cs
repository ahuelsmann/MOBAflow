...
public static class SkinResourceBuilder
{
    ...
    /// <summary>
    /// Creates the Violet skin ResourceDictionary (night-friendly).
    /// </summary>
    public static ResourceDictionary BuildVioletSkin()
    {
        var dict = new ResourceDictionary();
    ...
    /// <summary>
    /// Creates the Orange skin ResourceDictionary.
    /// </summary>
    public static ResourceDictionary BuildOrangeSkin()
    {
        ...
        // Control Backgrounds - Dark Style
    ...
    /// <summary>
    /// Creates the DarkOrange skin ResourceDictionary.
    /// </summary>
    public static ResourceDictionary BuildDarkOrangeSkin()
    {
        var dict = new ResourceDictionary();
