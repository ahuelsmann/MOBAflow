...
public static class FeatureToggleRegistry
{
    ...
    [
        ...
        nameof(FeatureToggleSettings.IsEventManagerPageAvailable),
        nameof(FeatureToggleSettings.IsWorkflowsPageAvailable),
        nameof(FeatureToggleSettings.IsStationsPageAvailable),
        ...
        nameof(FeatureToggleSettings.IsRecorderPageAvailable),
    ...
    private static readonly Dictionary<string, (Func<FeatureToggleSettings, bool> Get, Action<FeatureToggleSettings, bool> Set)> PageAvailabilityAccessors =
        new(StringComparer.Ordinal)
        {
            ...
            [nameof(FeatureToggleSettings.IsTimetablePageAvailable)] = (s => s.IsTimetablePageAvailable, (s, v) => s.IsTimetablePageAvailable = v),
            [nameof(FeatureToggleSettings.IsEventManagerPageAvailable)] = (s => s.IsEventManagerPageAvailable, (s, v) => s.IsEventManagerPageAvailable = v),
            [nameof(FeatureToggleSettings.IsWorkflowsPageAvailable)] = (s => s.IsWorkflowsPageAvailable, (s, v) => s.IsWorkflowsPageAvailable = v),
            [nameof(FeatureToggleSettings.IsStationsPageAvailable)] = (s => s.IsStationsPageAvailable, (s, v) => s.IsStationsPageAvailable = v),
            ...
            [nameof(FeatureToggleSettings.IsRecorderPageAvailable)] = (s => s.IsRecorderPageAvailable, (s, v) => s.IsRecorderPageAvailable = v),
    ...
    private static readonly Dictionary<string, Func<FeatureToggleSettings, string?>> BadgeLabelReaders =
        new(StringComparer.Ordinal)
        {
            ...
            [nameof(FeatureToggleSettings.TimetablePageLabel)] = ft => ft.TimetablePageLabel,
            [nameof(FeatureToggleSettings.EventManagerPageLabel)] = ft => ft.EventManagerPageLabel,
            [nameof(FeatureToggleSettings.WorkflowsPageLabel)] = ft => ft.WorkflowsPageLabel,
            [nameof(FeatureToggleSettings.StationsPageLabel)] = ft => ft.StationsPageLabel,
            ...
            [nameof(FeatureToggleSettings.RecorderPageLabel)] = ft => ft.RecorderPageLabel,
