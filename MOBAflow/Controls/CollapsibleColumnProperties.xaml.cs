...
/// </summary>
internal sealed partial class CollapsibleColumnProperties
{
    /// <summary>
    /// Header text displayed in both collapsed tab and expanded header.
    /// </summary>
    public static readonly DependencyProperty HeaderProperty =
        DependencyProperty.Register(nameof(Header), typeof(string), typeof(CollapsibleColumnProperties),
    ...
    public static readonly DependencyProperty GlyphProperty =
        DependencyProperty.Register(nameof(Glyph), typeof(string), typeof(CollapsibleColumnProperties),
    ...
    public static readonly DependencyProperty IsExpandedProperty =
        DependencyProperty.Register(nameof(IsExpanded), typeof(bool), typeof(CollapsibleColumnProperties),
    ...
    public static readonly DependencyProperty PanelContentProperty =
        DependencyProperty.Register(nameof(PanelContent), typeof(object), typeof(CollapsibleColumnProperties),
    ...
    public CollapsibleColumnProperties()
    {
        InitializeComponent();
        Loaded += OnLoaded;
    }
    ...
    {
        if (d is CollapsibleColumnProperties control)
