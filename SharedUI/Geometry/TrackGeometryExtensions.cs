...
namespace Moba.SharedUI.Geometry;
...
public static class TrackGeometryExtensions
{
    ...
    public static Transform2D GetInverseConnectorTransform(this TrackGeometry geometry, int connectorIndex)
    {
        ...
        // For inverse, we need to:
        // 1. Flip the rotation 180° (connector points outward, we need to point inward)
        // 2. Invert the translation
