...
using Moba.Domain.TrackPlan; // Use Domain TrackPoint
...
public class TrackGeometryLibrary
{
    ...
    /// <summary>
    /// Registers a dynamically generated geometry (e.g. from AnyRail import).
    /// Allows runtime addition of turnouts, DKW, W3, etc. without hardcoding templates.
    /// </summary>
    public void RegisterDynamicGeometry(string articleCode, List<TrackPoint> endpoints, List<double> headingsDeg, string pathData)
    {
        ...
        {
            // Already registered (static or dynamic) - skip duplicate
            return;
        }
