...
it does not authorize implementation. Calendar maintenance is removed by [#147](../004-remove-maintenance/spec.md); route reservations under #146. Neither is part of the 1.0 MVP.
