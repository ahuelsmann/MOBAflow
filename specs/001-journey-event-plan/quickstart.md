...
- Commit `4d5d1a63` was published to draft PR #125. The prior published head had failing Windows/Android analyzer-baseline checks and 36 OPEN/CONFIRMED SonarCloud findings; fresh remote checks are required. Local source corrections are not evidence that those remote gates have passed. Active analyzer baselines have not been changed.
