...
- [x] T033 Remove vehicle usage tracking, checkpoints, contracts, persistence hooks and UI; preserve InPort counters. Calendar maintenance retained at that stage is removed by [#147](../004-remove-maintenance/spec.md). Defer any future statistics to #143.
- [x] T034 Remove obsolete usage tests and schema/sample fields; adapt the then-retained calendar-maintenance regressions (superseded by [#147](../004-remove-maintenance/spec.md)).
