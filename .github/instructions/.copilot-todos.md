...
| 3. Ressourcen-Pfade relativ machen | Audio/Bild-Persistierung (GROSS!) | 8-10h | Seperate Initiative (siehe .copilot-todos Ressourcen) |
| 4. Panning-Feature: Implementieren oder Entfernen | TrackPlanEditorPage | 5-8h | Business-Decision: Wird Feature benoetigt? |
| **Phase 3 Total** | | **20-27h** | **DECISION POINTS** |
