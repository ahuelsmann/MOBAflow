...
## NEUE ARCHITEKTUR: App Shell & Responsive Layout (2026-01-15)

> **Ziel:** Zentrales App-Shell-Pattern und responsive Layouts fuer alle Multi-Column-Pages
> **Status:** ✅ ABGESCHLOSSEN - App startet erfolgreich, alle Pages migriert
...
### Responsive Layout System (WinUI/Controls/)

**AdaptivePanel Control:**

| Komponente | Beschreibung | Status |
|------------|--------------|--------|
| `AdaptivePanel` | Multi-Panel-Container mit Compact/Wide-Mode | ✅ Funktionsfaehig |
| `AdaptivePanelItem` | Panel-Definition (erbt von ContentControl) | ✅ Funktionsfaehig |
| `AdaptiveLayoutMode` | Enum: Compact, Medium, Wide | ✅ Implementiert |
| `AdaptiveStyles.xaml` | Styles fuer Tabs, Splitter, Panels | ✅ Implementiert |

### WinUI 3-spezifische Fixes (2026-01-15)

**Kritische Erkenntnisse fuer Custom Controls in WinUI 3:**

| Problem | Ursache | Loesung |
|---------|---------|---------|
| XAML-Parser Exception | `AdaptivePanelItem` erbte von `DependencyObject` | Geaendert zu `ContentControl` |
| Property-Name Konflikt | `Width` kollidiert mit `FrameworkElement.Width` | Umbenannt zu `PanelWidth` |
| GridLength-Konvertierung | WinUI 3 hat keinen TypeConverter | String + `GetGridLength()` Parser |
| Impliziter Style Crash | Custom Controls in ResourceDictionary | Nur explizite Styles mit x:Key |
| Resource-Zugriff Exception | Cast vor App-Initialisierung | `TryGetValue()` Pattern |

### Pages mit AdaptivePanel

| Page | Panels | Status |
|------|--------|--------|
| WorkflowsPage | 3 (Workflows, Actions, Properties) | ✅ Migriert |
| JourneysPage | 5 (Journeys, Stations, City Library, Workflow Library, Properties) | ✅ Migriert |
| TrainsPage | 4 (Locomotives, Passenger Wagons, Goods Wagons, Properties) | ✅ Migriert |
| TrainControlPage | Spezielles Speedometer-Layout | ⏭️ Nicht migriert (eigenes Layout) |
| TrackPlanEditorPage | Canvas-basierter Editor | ⏭️ Nicht migriert (Flyout-Toolbox) |

### Breakpoints

| Mode | Fensterbreite | Verhalten |
|------|---------------|-----------|
| **Compact** | < 640px | Tab-Navigation, ein Panel sichtbar |
| **Medium** | 640-1024px | Reduzierte Spalten |
| **Wide** | > 1024px | Alle Panels nebeneinander |

### Dokumentation

- `winui.instructions.md` - AdaptivePanel-Abschnitt hinzugefuegt
- Erkenntnisse zu WinUI 3 Custom Controls dokumentiert
