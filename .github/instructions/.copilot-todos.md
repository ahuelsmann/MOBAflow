...
### Neue Prototyp-Seiten

| Status | Feature | Details |
|--------|---------|---------|
| Done | **HelpPage (Wiki)** | `WinUI/View/HelpPage.cs` - C#-only Page mit WebView2 und TreeView Navigation. Zeigt Wiki-Dokumentation an. |
| Done | **SapTransactionPage** | `WinUI/View/SapTransactionPage.cs` - SAP-aehnliche Oberflaeche mit Command-Feld fuer Transaktionscodes, TreeView Menu, Command History. |
| Done | **Navigation registriert** | Beide Pages in App.xaml.cs und NavigationRegistry registriert, im MainWindow.xaml NavigationView hinzugefuegt. |
